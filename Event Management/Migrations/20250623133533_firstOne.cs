    ...
    public partial class firstOne : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttendanceEvent", x => new { x.AttendancesId, x.EventsId });
                    table.ForeignKey(
                        name: "FK_AttendanceEvent_Attendances_AttendancesId",
                        column: x => x.AttendancesId,
                        principalTable: "Attendances",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AttendanceEvent_Events_EventsId",
                        column: x => x.EventsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventOrganiser", x => new { x.EventsId, x.OrganisersId });
                    table.ForeignKey(
                        name: "FK_EventOrganiser_Events_EventsId",
                        column: x => x.EventsId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventOrganiser_Organisers_OrganisersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tickets_Attendances_AttendanceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceEvent_EventsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventOrganiser_OrganisersId",
